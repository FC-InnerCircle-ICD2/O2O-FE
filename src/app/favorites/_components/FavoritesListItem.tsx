...
const FavoritesListItem = ({ isRecent, isLast }: FavoritesListItemProps) => {
    return (
        <div className={cn("flex gap-2 bg-white px-mobile_safe py-4 border-b border-solid", isLast ? 'border-b-0' : 'border-b-gray-200')}>
            ...
            <div className="flex flex-1 flex-col justify-center gap-1">
                <p className="text-lg text-black font-medium">컴포즈커피-관악신사교차로점</p>
